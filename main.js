...
(function() {
  ...
  // ========================================
  // 9. ANIMATED COUNTER BAR (counts up on scroll)
  // ========================================
  function initCounterBar() {
    ...
    var observer = new IntersectionObserver(function(entries) {
      if (entries[0].isIntersecting && !animated) {
        ...
        counters.forEach(function(item) {
          var target = parseInt(item.dataset.target) || 0;
          var numberEl = item.querySelector('.counter-number');
          if (!numberEl) return;
  ...
  // ========================================
  // 10. GPTW YEARS BADGE (about section)
  // ========================================
  function initGPTWYearsBadge() {
    var el = document.getElementById('gptwYears');
    if (!el) return;
    ...
    var observer = new IntersectionObserver(function(entries) {
      if (entries[0].isIntersecting && !animated) {
        ...
        function step() {
          n++;
          el.innerHTML = '<img src="' + (document.querySelector('.about-image img') ? document.querySelector('.about-image img').src : '') + '" alt="GPTW" style="height:24px;width:auto;border-radius:0;box-shadow:none;">' +
            '<span>Great Place to Work® <strong>' + n + '</strong> 年连续</span>';
